activate_this = '/var/www/html/item-catalog/item-catalog-venv/bin/activate_this.py'
...
CLIENT_ID = json.loads(
    open('/var/www/html/item-catalog/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/html/item-catalog/client_secrets.json', scope='')
